...
const SkillsSection = () => {
  ...
  const renderSectionTitle = (): React.ReactNode => (
    <div className="flex flex-col">
      ...
      I am an individual who eager to learn and explore new fields of life and technology, with good listening skills and fast learning abilities.{" "}
      </h2>
    </div>
  );
    ...
    <section className="relative">
      ...
      >
        <div className="flex flex-col skills-wrapper">
          {renderSectionTitle()}
          <div className="mt-10">
            {renderSkillColumn("PROGRAMMING LANGUAGES", SKILLS.tech)}
          </div>
          <div className="mt-10">
            {renderSkillColumn("FRAMEWORKS AND TOOLS", SKILLS.tech2)}
          </div>
          <div className="mt-10">
            {renderSkillColumn("SOFT SKILLS", SKILLS.soft)}
          </div>
        </div>
      </div>
    </section>
